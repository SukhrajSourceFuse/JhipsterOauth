...
using Scrutor;
using JhipsterOauth.Domain.Entities;
using JhipsterOauth.Domain.Repositories.Interfaces;
using JhipsterOauth.Infrastructure.Data.Repositories;

namespace JhipsterOauth.Configuration;
...
public static class RepositoryStartup
{
    public static IServiceCollection AddRepositoryModule(this IServiceCollection services)
    {
        ...
        services.Scan(scan => scan
            ...
            .AddClasses(classes => classes.InNamespaces("JhipsterOauth.Infrastructure.Data.Repositories"))
            ...
            .AddClasses(classes => classes.Where(type => type.Namespace.Equals("JhipsterOauth.Infrastructure.Data.Repositories") &&
